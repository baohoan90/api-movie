...
@Service
public class InstagramOAuth2UserInfoExtractor implements OAuth2UserInfoExtractor {
    ...
    public CustomUserDetails extractUserInfo(OAuth2User oAuth2User) {
        ...
        customUserDetails.setProvider(OAuth2Provider.INSTAGRAM);
    ...
    public boolean accepts(OAuth2UserRequest userRequest) {
        return OAuth2Provider.INSTAGRAM.name().equalsIgnoreCase(userRequest.getClientRegistration().getRegistrationId());
    }
